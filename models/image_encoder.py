...
class ImageEncoder(nn.Module):
    ...
    def forward(self, images, image_titles):
        ...
        text_features = self.clip_model.get_text_features(input_ids=image_titles['input_ids'],
                                                          attention_mask=image_titles['attention_mask'])
